...
@interface ImagesTableTableViewController () <MediaTableViewCellDelegate, UIViewControllerTransitioningDelegate, CameraViewControllerDelegate, ImageLibraryViewControllerDelegate>
...
- (void)dealloc {
    [[self items] removeObserver:self forKeyPath:@"mediaItems"];
...
- (NSMutableArray *)items {
    NSMutableArray *items = [NSMutableArray arrayWithArray:[DataSource sharedInstance].mediaItems];
    return items;
}
...
#pragma mark - Camera, CameraViewControllerDelegate, and ImageLibaryCollectionViewControllerDelegate
